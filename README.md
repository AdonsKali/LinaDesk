...
### 2. Установка Сuda Toolkit (Nvidia):

> Данная утилита нужна для ускорения генерацими текста. Устанавливайте в том случае, если у вас есть Nvidia GPU.
Ссылка: [CUDA](https://developer.nvidia.com/cuda/toolkit)
...
> **Примечание:** Убедитесь, что у вас установлен [NodeJS](https://nodejs.org/en) (или его аналоги [BunJS](https://bun.com), [DenoJS](https://deno.com)), чтобы использовать функции поиска в сети.
...
> **Установка может занять до часа. Все зависит от вашего железа.**
